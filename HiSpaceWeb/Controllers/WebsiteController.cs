...
namespace HiSpaceWeb.Controllers
{
    public class WebsiteController : Controller
    {
        ...
        [HttpPost]
        public IActionResult AddSeats(List<MemberBookingSpaceSeat> SeatList)
        {
            SetSessionVariables();
            ...
            foreach (var seat in SeatList)
            {
                ...
                {
                    sessionSpaceObject.Add(new MemberBookingSpace() { ClientSpaceFloorPlanID = seat.MemberBookingSpaceID });
                }
        ...
        [HttpPost]
        public IActionResult RemoveSeats(List<MemberBookingSpaceSeat> SeatList)
        {
            SetSessionVariables();
