	...
	{ // GET: Table
		...
		public ActionResult Create(ClientSpaceViewModel model, IFormCollection formCollection)
		{
			...
			if (model.FloorPlanFile != null)
			{
				...
				uploadsFolder += "\\" + "client" + "\\" + GetSessionObject().ClientID + "\\";
				...
				DuplicateName = "_FloorPlan_" + Guid.NewGuid().ToString() + extension;
				...
				model.ClientSpaceFloorPlan.FloorPlanFilePath = uploadsFolder + DuplicateName;
			}
